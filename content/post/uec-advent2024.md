...
(補足: ハッシュマップは忘却計算量が入ることがあると思いますが、このあたりを$\text{expected}$などと合わせたときにどう扱うのかについて、文献を探しても見つかりませんでした。なので、基本的には期待計算量に含まれるという体で書いています。)
...
私のささやかな願いとして、このエントリ調布駅のTrieをみて「トライ」と読んでしまう人が増えるといいなと思っています。
